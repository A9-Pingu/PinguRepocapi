...
namespace ConsoleGame.Managers
{
    public class QuestManager
    {
        ...
        public void InitQuest()
        {
            ...
            dicQuestInfos.Add(QuestNum++, new Quest(QuestNum,"장비를 장착해보자", "이봐 형씨 아무것도 안입고 어딜 그렇게 가나. 마침 김씨네 상점에 좋은 물건이 들어왔으니 한 번 가보는게 어때?", "장비아이템 장착하기",1, 1000, Game.instance.itemManager.ItemInfos[13]));
