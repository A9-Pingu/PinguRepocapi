...
namespace ConsoleGame.Managers
{
    public class ItemManager
    {
        ...
        public void InitItemList()
        {
            ...
            specialItems.Add(new Item(UniqueKey++, "마법의 지팡이" , ItemType.Weapon     , 9000  , SetItemStatus(e_ItemStatusType.Attack    , 35) , "마법사의 필수 아이템입니다."               , true));
            specialItems.Add(new Item(UniqueKey++, "빛의 검"       , ItemType.Weapon     , 9500  , SetItemStatus(e_ItemStatusType.Attack    , 38) , "빛의 힘을 가진 검입니다."                  , true));
            specialItems.Add(new Item(UniqueKey++, "용의 검"       , ItemType.Weapon     , 10000 , SetItemStatus(e_ItemStatusType.Attack    , 40) , "드래곤의 힘을 담은 무기입니다."            , true));
            specialItems.Add(new Item(UniqueKey++, "마력의 로브"   , ItemType.Armor      , 11000 , SetItemStatus(e_ItemStatusType.Defense   , 45) , "마법의 힘을 강화시켜주는 로브입니다."      , true));
            specialItems.Add(new Item(UniqueKey++, "천사의 날개"   , ItemType.Armor      , 11500 , SetItemStatus(e_ItemStatusType.Defense   , 48) , "천사의 보호를 받는 날개입니다."            , true));
            specialItems.Add(new Item(UniqueKey++, "신의 갑옷"     , ItemType.Armor      , 12000 , SetItemStatus(e_ItemStatusType.Defense   , 50) , "신들의 보호를 받는 갑옷입니다."            , true));
            specialItems.Add(new Item(UniqueKey++, "천둥의 방패"   , ItemType.Armor      , 13000 , SetItemStatus(e_ItemStatusType.Defense   , 55) , "천둥의 힘으로 공격을 막아주는 방패입니다." , true));
            specialItems.Add(new Item(UniqueKey++, "지혜의 서"     , ItemType.Consumable , 18000 , SetItemStatus(e_ItemStatusType.MaxHealth , 30) , "지식과 경험을 향상시켜주는 서입니다."      , true));
        }
