...
namespace ConsoleGame.Managers
{
    public class ItemManager
    {
        ...
        {
            new Item("수련자 갑옷", ItemType.Armor, 1000, 5, "수련에 도움을 주는 갑옷입니다."),
            ...
            new Item("낡은 검", ItemType.Weapon, 600, 2, "쉽게 볼 수 있는 낡은 검입니다."),
            ...
            new Item("여명의 시미터", ItemType.Weapon, 3500, 20, "달의 여신의 축복을 받아 만들어진 검입니다."),
